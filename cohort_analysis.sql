...
--Converting Unix timestamp into real time and finding the days that players made purchase by taking difference between install time and event time with revenue included
